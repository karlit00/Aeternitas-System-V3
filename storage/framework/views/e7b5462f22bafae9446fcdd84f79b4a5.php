        ...
        <div class="flex items-center space-x-1 sm:space-x-2 lg:space-x-3 flex-shrink-0">
            ...
            <div class="relative" x-data="{
                ...
                async loadMessages() {
                    this.loading = true;
                    try {
                        const response = await fetch('<?php echo e(route('hr.inbox.quick')); ?>', {
                            headers: {
                ...
                <div x-show="open" 
                    ...
                    <!-- Footer -->
                    <div class="px-4 py-2 border-t border-gray-100 bg-gray-50">
                        <a href="<?php echo e(route('hr.contacts.admin')); ?>" class="text-xs text-indigo-600 hover:text-indigo-800 font-medium inline-flex items-center gap-1">
                            View All Messages
...
</script><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/components/dashboard/header.blade.php ENDPATH**/ ?>