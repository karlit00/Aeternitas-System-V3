...
<?php $__env->startSection('title', 'End of Contracts Report'); ?>
...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($totalContracts); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($expiringThisMonth); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(max(0, $totalContracts - $expiringThisMonth)); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Showing <?php echo e($employees->firstItem()); ?> to <?php echo e($employees->lastItem()); ?> of <?php echo e($employees->total()); ?> contracts</p>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        ?>
                        <tr class="hover:bg-gray-50 transition-colors <?php echo e($isVeryUrgent ? 'bg-red-50' : ($isUrgent ? 'bg-yellow-50' : '')); ?>">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 bg-gray-200 rounded-full flex items-center justify-center">
                                        <span class="text-sm font-medium text-gray-700"><?php echo e(strtoupper(substr($employee->first_name, 0, 1))); ?><?php echo e(strtoupper(substr($employee->last_name, 0, 1))); ?></span>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($employee->employee_id); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($employee->position->name ?? 'N/A'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($employee->department->name ?? 'N/A'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($employee->employment_type === 'probationary' ? 'bg-yellow-100 text-yellow-800' : ($employee->employment_type === 'contractual' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800')); ?>">
                                    <?php echo e(ucfirst($employee->employment_type ?? 'Regular')); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($contractEndDate->format('M j, Y')); ?>

                                <?php if(!$hasContractEndDate): ?>
                                    <span class="text-xs text-gray-500 ml-1">(estimated)</span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($isVeryUrgent ? 'bg-red-100 text-red-800' : ($isUrgent ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800')); ?>">
                                    <?php echo e($daysRemaining > 0 ? $daysRemaining . ' days' : 'Expired'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                ...
                                <button onclick="renewContract(<?php echo e($employee->id); ?>)" 
                                        class="text-green-600 hover:text-green-900" title="Renew Contract">
                                    <i class="fas fa-sync"></i>
                                </button>
                                <button onclick="sendReminder(<?php echo e($employee->id); ?>)" 
    ...
    <div class="mt-6 bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-blue-600"><?php echo e($totalContracts); ?></p>
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-red-600"><?php echo e($expiringThisMonth); ?></p>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-yellow-600"><?php echo e(max(0, $totalContracts - $expiringThisMonth)); ?></p>
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-green-600"><?php echo e($departments->count()); ?></p>
...
<script>
    ...
    function sendReminders() {
        ...
        // Send AJAX request
        fetch('<?php echo e(route("hr.reports.end-of-contracts")); ?>/send-reminders', {
            method: 'POST',
            headers: {
    ...
    function sendReminder(employeeId) {
        ...
        fetch(`<?php echo e(route("hr.reports.end-of-contracts")); ?>/send-reminder/${employeeId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    function exportContractsReport() {
        ...
        fetch(`<?php echo e(route("hr.reports.end-of-contracts")); ?>?export=all`, {
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
    ...
    function generateRenewalLetters() {
        ...
        fetch('<?php echo e(route("hr.reports.end-of-contracts")); ?>/generate-renewal-letters', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    function scheduleReminders() {
        ...
        fetch('<?php echo e(route("hr.reports.end-of-contracts")); ?>/schedule-reminders', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => auth()->user(), 'activeRoute' => 'hr.reports.end-of-contracts'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/hr/reports/end-of-contracts.blade.php ENDPATH**/ ?>