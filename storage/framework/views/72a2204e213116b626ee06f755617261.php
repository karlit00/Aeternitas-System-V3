...
<?php $__env->startSection('title', 'Confidential Files - ' . $employee->full_name); ?>
...
<div class="min-h-screen bg-gray-50">
            ...
            <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <?php if($confidentialData['medical_records']): ?>
                            <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Medical Records', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['medical_records'])])); ?>')"
                               class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                View
                            </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['medical_records'])])); ?>" 
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <?php if($confidentialData['medical_leave_documents']): ?>
                            <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Medical Leave Documents', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['medical_leave_documents'])])); ?>')"
                               class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                View
                            </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['medical_leave_documents'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <?php if($confidentialData['health_insurance_info']): ?>
                            <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Health Insurance Info', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['health_insurance_info'])])); ?>')"
                               class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                View
                            </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['health_insurance_info'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <?php if($confidentialData['background_checks']): ?>
                            <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Background Checks', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['background_checks'])])); ?>')"
                               class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                View
                            </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['background_checks'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 lg:col-span-2">
            ...
            <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <?php if($confidentialData['child_support_garnishment']): ?>
                            <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Child Support/Garnishment', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['child_support_garnishment'])])); ?>')"
                               class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                View
                            </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['child_support_garnishment'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <?php if($confidentialData['bank_details']): ?>
                            <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Bank Details', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['bank_details'])])); ?>')"
                               class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                View
                            </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['bank_details'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
            ...
            <div class="space-y-3">
                ...
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <?php if($confidentialData['i9_forms']): ?>
                                <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'I-9 Forms', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['i9_forms'])])); ?>')"
                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </button>
                                    <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['i9_forms'])])); ?>" 
                                          method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
                ...
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <?php if($confidentialData['work_eligibility']): ?>
                                <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Work Eligibility', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'confidential', basename($confidentialData['work_eligibility'])])); ?>')"
                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </button>
                                    <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'confidential', basename($confidentialData['work_eligibility'])])); ?>" 
                                          method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mt-6">
        ...
        <p class="text-gray-600 mb-4">Upload additional confidential documents for <?php echo e($employee->full_name); ?></p>
        ...
        <form action="<?php echo e(route('hr.employee-personnel-files.upload', [$employee->id, 'confidential'])); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => auth()->user(), 'activeRoute' => 'hr.employee-personnel-files'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/hr/employee-personnel-files/confidential.blade.php ENDPATH**/ ?>