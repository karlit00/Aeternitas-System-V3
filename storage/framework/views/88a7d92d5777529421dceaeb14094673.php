...
<?php $__env->startSection('title', 'New Employees Report'); ?>
...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($newEmployees->total()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($newEmployees->where('created_at', '>=', now()->startOfMonth())->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(round($newEmployees->total() / 3)); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Showing <?php echo e($newEmployees->firstItem()); ?> to <?php echo e($newEmployees->lastItem()); ?> of <?php echo e($newEmployees->total()); ?> new employees</p>
        </div>
        
        <?php if($newEmployees->isEmpty()): ?>
        ...
        <?php else: ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $newEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($employee->created_at->format('M j, Y')); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                <?php echo e($newEmployees->appends(request()->query())->links()); ?>
    ...
    <div class="mt-6 bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-blue-600"><?php echo e($newEmployees->count()); ?></p>
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-purple-600"><?php echo e($departments->count()); ?></p>
            ...
            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                ...
                <p class="text-2xl font-bold text-orange-600"><?php echo e($positions->count()); ?></p>
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => auth()->user(), 'activeRoute' => 'hr.reports.new-employees'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/hr/reports/new-employees.blade.php ENDPATH**/ ?>