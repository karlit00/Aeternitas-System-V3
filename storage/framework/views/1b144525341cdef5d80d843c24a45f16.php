...
<?php $__env->startSection('title', 'Employment Details - ' . $employee->full_name); ?>
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-3">
                ...
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <?php if($employmentData['job_description']): ?>
                                <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Job Description', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'employment', basename($employmentData['job_description'])])); ?>')"
                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'employment', basename($employmentData['job_description'])])); ?>" 
                ...
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <?php if($employmentData['tax_forms']): ?>
                                <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Tax Forms', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'employment', basename($employmentData['tax_forms'])])); ?>')"
                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'employment', basename($employmentData['tax_forms'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
            ...
            <div class="space-y-3">
                ...
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <?php if($employmentData['emergency_contact']): ?>
                                <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Emergency Contact', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'employment', basename($employmentData['emergency_contact'])])); ?>')"
                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'employment', basename($employmentData['emergency_contact'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
                ...
                <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <?php if($employmentData['salary_history']): ?>
                                <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Salary History', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'employment', basename($employmentData['salary_history'])])); ?>')"
                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </button>
                                <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'employment', basename($employmentData['salary_history'])])); ?>" 
                                      method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 lg:col-span-2">
            ...
            <?php if($employmentData['previous_employments']->count() > 0): ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $employmentData['previous_employments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prevEmp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <i class="fas fa-file-pdf text-red-500 text-lg"></i>
                                <div>
                                    <h3 class="font-medium text-gray-900"><?php echo e($prevEmp->company_name); ?></h3>
                                    <p class="text-sm text-gray-500"><?php echo e($prevEmp->position); ?> • <?php echo e($prevEmp->start_date); ?> to <?php echo e($prevEmp->end_date); ?></p>
                                    <p class="text-xs text-gray-400">Reason for leaving: <?php echo e($prevEmp->reason_for_leaving); ?></p>
                                </div>
                            </div>
                            <div class="flex space-x-2">
                                <?php if($prevEmp->document): ?>
                                    <button onclick="openDocumentModal('<?php echo e($employee->full_name); ?>', 'Previous Employment Document', '<?php echo e(route('hr.employee-personnel-files.view', [$employee->id, 'employment', basename($prevEmp->document)])); ?>')"
                                       class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                        View
                                    </button>
                                    <form action="<?php echo e(route('hr.employee-personnel-files.delete', [$employee->id, 'employment', basename($prevEmp->document)])); ?>" 
                                          method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this file?')">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="text-red-600 hover:text-red-800 text-sm font-medium">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mt-6">
        ...
        <p class="text-gray-600 mb-4">Upload additional employment-related documents for <?php echo e($employee->full_name); ?></p>
        
        <form action="<?php echo e(route('hr.employee-personnel-files.upload', [$employee->id, 'employment'])); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => auth()->user(), 'activeRoute' => 'hr.employee-personnel-files'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/hr/employee-personnel-files/employment.blade.php ENDPATH**/ ?>