...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Help & Support Center','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Help & Support Center','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                ['name' => 'Dashboard', 'route' => route('dashboard')],
                ['name' => 'Help & Support', 'current' => true]
            ])]); ?>
...
<?php endif; ?>
        ...
        <div id="faq" class="mb-12">
            ...
            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faqGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-8">
                    <h3 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b-2 border-blue-500">
                        <i class="fas fa-folder-open text-blue-600 mr-2"></i><?php echo e($faqGroup['category']); ?>

                    </h3>
                    
                    <div class="space-y-4">
                        <?php $__currentLoopData = $faqGroup['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition">
                                <button class="faq-toggle w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition" onclick="toggleFaq(this)">
                                    <span class="text-left font-medium text-gray-900"><?php echo e($faq['question']); ?></span>
        ...
        <div id="troubleshooting" class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <?php $__currentLoopData = $troubleshooting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">
                            <i class="fas fa-exclamation-triangle text-purple-600 mr-2"></i><?php echo e($issue['title']); ?>

                        </h3>
                        
                        <ol class="space-y-2">
                            <?php $__currentLoopData = $issue['steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="support-form" class="bg-white rounded-lg shadow-md p-8 border-t-4 border-green-500">
            ...
            <form method="POST" action="<?php echo e(route('hr.help-support-ticket-store')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="<?php echo e(route('hr.help-support')); ?>" class="flex-1 bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400 transition font-medium text-center">
                        Clear
                    </a>
                </div>
            </form>
        ...
        <div class="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-8">
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('hr.contact.index')); ?>" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium">
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'hr.help-support'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/help-support.blade.php ENDPATH**/ ?>