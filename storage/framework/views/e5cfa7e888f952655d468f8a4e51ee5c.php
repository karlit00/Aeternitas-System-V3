                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-sm text-gray-900"><?php echo e(Str::limit($contact->subject, 30)); ?></p>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'hr.contacts.admin'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\internship\Aeternitas-System-V2\resources\views/hr/contacts-admin.blade.php ENDPATH**/ ?>