...
<?php $__env->startSection('title', 'Employee Offences'); ?>
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600"><?php echo e($stats['serious']); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <form method="GET" action="<?php echo e(route('hr.reports.employee-offences')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Search</label>
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Employee name or ID..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    ...
                    <select name="department" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($department->id); ?>" <?php echo e(request('department') == $department->id ? 'selected' : ''); ?>><?php echo e($department->name); ?></option>
                ...
                <div>
                    ...
                    <select name="severity" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <option value="serious" <?php echo e(request('severity') == 'serious' ? 'selected' : ''); ?>>Serious</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <input type="date" name="start_date" value="<?php echo e(request('start_date')); ?>" class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <input type="date" name="end_date" value="<?php echo e(request('end_date')); ?>" class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
                <div class="lg:col-span-5 flex justify-end space-x-3">
                    ...
                    <a href="<?php echo e(route('hr.reports.employee-offences')); ?>" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-200 transition-colors">
        ...
        <div class="bg-white rounded-lg shadow-md">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">Showing <?php echo e($offences->firstItem() ?? 0); ?> to <?php echo e($offences->lastItem() ?? 0); ?> of <?php echo e($offences->total()); ?> records</p>
            </div>
            
            <?php if($offences->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $offences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-gray-200 rounded-full flex items-center justify-center">
                                            <span class="text-sm font-medium text-gray-700"><?php echo e(strtoupper(substr($offence->employee->first_name ?? 'N', 0, 1))); ?><?php echo e(strtoupper(substr($offence->employee->last_name ?? 'A', 0, 1))); ?></span>
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($offence->employee->full_name ?? 'N/A'); ?></div>
                                            <div class="text-sm text-gray-500"><?php echo e($offence->employee->employee_id ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($offence->offence_type); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($offence->offence_date->format('M j, Y')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($offence->severity_badge_class); ?>">
                                        <?php echo e(ucfirst($offence->severity)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($offence->status_badge_class); ?>">
                                        <?php echo e(ucfirst($offence->status)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <form action="<?php echo e(route('hr.reports.employee-offences.destroy', $offence->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="px-6 py-4 border-t border-gray-200">
                    <?php echo e($offences->appends(request()->query())->links()); ?>
...
<div id="addOffenceModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50 flex items-center justify-center overflow-y-auto">
    <div class="relative mx-auto p-6 w-full max-w-2xl border shadow-lg rounded-lg bg-white my-8">
        ...
        <form action="<?php echo e(route('hr.reports.employee-offences.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-6">
                <!-- Employee Selection -->
                <div>
                    ...
                    <div id="employeeDropdown" class="hidden mt-2 max-h-60 overflow-y-auto border border-gray-200 rounded-lg bg-white shadow-lg">
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="employee-option p-3 hover:bg-blue-50 cursor-pointer transition-colors border-b border-gray-100 last:border-b-0"
                                 ...
                                 data-employee-id-number="<?php echo e($employee->employee_id); ?>">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="text-sm text-gray-500"><?php echo e($employee->employee_id); ?> - <?php echo e($employee->department->name ?? 'No Department'); ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="reported_by" value="<?php echo e(auth()->user()->name ?? ''); ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard-base', ['user' => auth()->user(), 'activeRoute' => 'hr.reports.employee-offences'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sushitrash\Desktop\Aeternitas-System-V2-1\resources\views/hr/reports/employee-offences.blade.php ENDPATH**/ ?>