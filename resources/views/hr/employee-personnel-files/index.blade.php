...
@section('title', 'Employee Personnel Files')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select id="filter-department" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    @foreach($employees->pluck('department.name', 'department.id')->unique()->sort() as $id => $name)
            ...
            <div>
                ...
                <select id="filter-position" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    @foreach($employees->pluck('position.name', 'position.id')->unique()->sort() as $id => $name)
                        <option value="{{ $id }}">{{ $name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm">{{ $employee->employee_id }}</p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm">{{ $employee->position->name ?? 'N/A' }}</p>
                        <p class="text-xs text-blue-100">{{ $employee->department->name ?? 'N/A' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="border rounded-lg p-3 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('hr.employee-personnel-files.performance', $employee->id) }}" 
                           class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                            View Files →
                        </a>
                    </div>
                ...
                <div class="border rounded-lg p-3 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('hr.employee-personnel-files.offboarding', $employee->id) }}" 
                           class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                            View Files →
                        </a>
                    </div>
                ...
                <div class="border rounded-lg p-3 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('hr.employee-personnel-files.confidential', $employee->id) }}" 
                           class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                            View Files →
                        </a>
                    </div>
