@extends('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'employee-info.index'])

@section('title', 'Employee Info & Documents')
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-800">
                                        ...
                                        {{ $employee->documents_count ?? 0 }} documents
                                    </span>
                                    @if($employee->documents_count > 0)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button onclick="viewEmployeeDocuments({{ $employee->id }})" 
